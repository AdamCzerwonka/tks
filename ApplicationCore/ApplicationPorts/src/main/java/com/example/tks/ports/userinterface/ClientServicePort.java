...
public interface ClientServicePort<T, C, U> {
    List<T> get();
    ...
    T create(C clientCreateRequest) throws LoginAlreadyTakenException;

    T update(U clientUpdateRequest) throws NotFoundException;
